function [rho_solid] = func_main_im2mesh(fileName, threshold_frac)
...
threshold_mucus = max(Z(:)) * threshold_frac; % threshold to consider what is mucin and what is not
fact_tanh = 100;
Z = Z-threshold_mucus;
Z = tanh(Z*fact_tanh);
