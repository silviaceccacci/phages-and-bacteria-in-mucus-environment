function func_Fluid_Solid_mesh(fileName, fixed_stokes_threshold)
...
threshold_mucus = max(Z(:)) * fixed_stokes_threshold; % threshold to consider what is mucin and what is not
fact_tanh = 100;
