function [u_rescaled] = func_main_flowSolverBrinkman(case_name, Da, thresh)
...
parameters.minDarcyNum  = Da ; % perme->0      : more resistance % adimensional, Darcy number
...
opt_out = solution;
opt_out.name = sprintf('./output/paraview/%s_sol_rescaled_Brink_Da%.2e_thresh%.2f', parameters.case_name, Da, thresh);
